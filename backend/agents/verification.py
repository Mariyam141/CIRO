...
DEFAULT_SYSTEM_PROMPT = """You are the Verification Agent - Step 5 of 5 in the CIRO agentic pipeline \
...
SYSTEM_PROMPT = get_agent_system_prompt("verification", DEFAULT_SYSTEM_PROMPT)
...
updated_classification must be the new crisis type string if reclassified, otherwise null"""
    ...
    return call_llm(SYSTEM_PROMPT, user_message, agent_key="verification")
