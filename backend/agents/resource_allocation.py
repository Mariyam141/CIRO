...
DEFAULT_SYSTEM_PROMPT = """You are the Resource Allocation Agent - Step 3 of 5 in the CIRO agentic pipeline \
...
SYSTEM_PROMPT = get_agent_system_prompt("resource_allocation", DEFAULT_SYSTEM_PROMPT)
...
5. Compute resource_utilization as a percentage: deployed_units / total_units x 100.
...
Use ONLY unit IDs that appear in the FULL RESOURCE INVENTORY above."""
    ...
    return call_llm(SYSTEM_PROMPT, user_message, agent_key="resource_allocation")
